...
public class Contact implements BaseModel {
    ...
    public Contact(Long id, long memberid, long contactid, String email, String name, String headbig, String headmid, String headsmall, java.util.Date registetime, java.util.Date createtime, String pinyin) {
        this.id = id;
