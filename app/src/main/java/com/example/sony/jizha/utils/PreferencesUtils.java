...
/**
 * PreferencesUtils, easy to get or put data保存信息
 * 轻量级应用程序内部轻量级的存储方案,特别适合用于保存软件配置参数,比如boolean,int,float,long,String等数据.
...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "jizha_Pref_Common";
