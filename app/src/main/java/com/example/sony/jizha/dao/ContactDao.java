...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Registetime = new Property(8, java.util.Date.class, "registetime", false, "REGISTETIME");
    ...
    protected void bindValues(SQLiteStatement stmt, Contact entity) {
        ...
        stmt.bindLong(9, entity.getRegistetime()==null?new Date().getTime():entity.getRegistetime().getTime());
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
                ...
                new java.util.Date(cursor.getLong(offset + 8)), // registetime
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setRegistetime(new java.util.Date(cursor.getLong(offset + 8)));
